...
namespace Johnny.Tutorials.RestfulAspNet.Controllers
{
    ...
    public class UploadController : Controller
    {
        ...
        public UploadController(IWebHostEnvironment hostingEnvironment, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<IActionResult> Get()
        {
            ...
            ResponseResult rr =  new ResponseResult();
            rr.StatusCode = StatusCodes.Status200OK;
            rr.Message = "http://localhost:4000/images/636494637368678780_controller.jpg";
            return  Ok(rr);
        }
